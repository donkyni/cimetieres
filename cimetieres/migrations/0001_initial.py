# Generated by Django 3.2 on 2021-10-15 10:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(auto_now_add=True, null=True)),
                ('droit', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='cimetieres.droits')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cadastre_tombe', models.IntegerField(blank=True, null=True)),
                ('emplacement_tombe', models.CharField(blank=True, max_length=255, null=True)),
                ('nom_defunt_tombe', models.CharField(blank=True, max_length=255, null=True)),
                ('naissance_defunt_tombe', models.CharField(blank=True, default=None, max_length=255, null=True)),
                ('deces_defunt_tombe', models.CharField(blank=True, default=None, max_length=255, null=True)),
                ('age_defunt_tombe', models.CharField(blank=True, max_length=500, null=True)),
                ...
                ('archive_tombe', models.BooleanField(blank=True, default=False, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Profils',
            fields=[
                ...
                ('archive', models.BooleanField(default=False, null=True)),
                ('date', models.DateTimeField(auto_now_add=True, null=True)),
                ('droits', models.ManyToManyField(through='cimetieres.DroitsProfils', to='cimetieres.Droits')),
            ],
            options={
                'verbose_name': 'Profil',
        ...
        migrations.AddField(
            ...
            name='profil',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='cimetieres.profils'),
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('profil', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='cimetieres.profils')),
