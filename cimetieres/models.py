...
class Tombe(models.Model):
    ...
    cadastre_tombe = models.IntegerField(null=True, blank=True)
    emplacement_tombe = models.CharField(max_length=255, null=True, unique=True, blank=True)
    nom_defunt_tombe = models.CharField(max_length=255, null=True, blank=True)
    naissance_defunt_tombe = models.DateField(null=True, blank=True)
    deces_defunt_tombe = models.DateField(null=True, blank=True)
    age_defunt_tombe = models.IntegerField(null=True, blank=True)
    ...
    archive_tombe = models.BooleanField(default=False, null=True, blank=True)
"""


class Tombe(models.Model):
    division = models.CharField(max_length=250, null=True, blank=True)
    cadastre_tombe = models.CharField(max_length=255, null=True, blank=True)
    emplacement_tombe = models.CharField(max_length=251, null=True, blank=True)
    nom_defunt_tombe = models.TextField(null=True, blank=True)
    naissance_defunt_tombe = models.CharField(max_length=253, null=True, blank=True, default=None)
    deces_defunt_tombe = models.TextField(null=True, blank=True)
    age_defunt_tombe = models.CharField(max_length=254, null=True, blank=True)
    dimension = models.CharField(max_length=255, null=True, blank=True)
    observation = models.CharField(max_length=249, null=True, blank=True)
    date_enregistrement = models.DateField(auto_now_add=True, null=True, blank=True)
    archive_tombe = models.BooleanField(default=False, null=True, blank=True)
